...
CREATE UNIQUE INDEX "domains_name_owned_uniq" ON "domains" USING btree ("name") WHERE "domains"."ownership" = 'owned';--> statement-breakpoint
CREATE INDEX "domains_name_idx" ON "domains" USING btree ("name");