 ...
 *
 * この 2 つを `/auth/me` に載せることは requirements v0.1.8 §10.1 で確定済み
 * （`docs/specs/ui-screens.md` §7 の要確認 #2 / #3 は解決）。AI 設定の更新は
 * `PATCH /settings/ai`（`aiSettingsUpdateRequestSchema`）が担い、読み出しはここに残す。
 */
